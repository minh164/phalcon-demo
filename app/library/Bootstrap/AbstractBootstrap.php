...
//            ->addCss('//netdna.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css', false)
            ->addCss('//fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700', false)
            ->addCss($utils->getAsset('css/admin/plugins/fontawesome-free/css/all.min.css'), $utils->isCdnLocal())
            ->addCss($utils->getAsset('css/admin/dist/css/adminlte.min.css'), $utils->isCdnLocal())
            ->addCss('//code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css', false)

            ->addCss($utils->getAsset('css/admin/plugins/daterangepicker/daterangepicker.css'), $utils->isCdnLocal())
            ->addCss($utils->getAsset('css/admin/plugins/icheck-bootstrap/icheck-bootstrap.min.css'), $utils->isCdnLocal())
            ->addCss($utils->getAsset('css/admin/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css'), $utils->isCdnLocal())
            ->addCss($utils->getAsset('css/admin/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css'), $utils->isCdnLocal())
            ->addCss($utils->getAsset('css/admin/plugins/select2/css/select2.min.css'), $utils->isCdnLocal())
            ->addCss($utils->getAsset('css/admin/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css'), $utils->isCdnLocal())
            ->addCss($utils->getAsset('css/admin/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css'), $utils->isCdnLocal())

        ;

        $assets
            ->collection('footer_js')
            ->addJs('//code.jquery.com/jquery-3.4.1.slim.js', false)
            ...
            ->addJs($utils->getAsset('js/admin/plugins/jquery/jquery.min.js'), $utils->isCdnLocal())
            ->addJs($utils->getAsset('js/admin/plugins/bootstrap/js/bootstrap.bundle.min.js'), $utils->isCdnLocal())
            ->addJs($utils->getAsset('js/admin/dist/js/adminlte.min.js'), $utils->isCdnLocal())
            ->addJs($utils->getAsset('js/admin/dist/js/demo.js'), $utils->isCdnLocal())

            ->addJs($utils->getAsset('css/admin/plugins/select2/js/select2.full.min.js'), $utils->isCdnLocal())
            ->addJs($utils->getAsset('css/admin/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js'), $utils->isCdnLocal())
            ->addJs($utils->getAsset('css/admin/plugins/moment/moment.min.js'), $utils->isCdnLocal())
            ->addJs($utils->getAsset('css/admin/plugins/daterangepicker/daterangepicker.js'), $utils->isCdnLocal())
            ->addJs($utils->getAsset('css/admin/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js'), $utils->isCdnLocal())
            ->addJs($utils->getAsset('css/admin/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js'), $utils->isCdnLocal())
    ...
    protected function initRegistry()
    {
        ...
        $registry->view          = 'admin/dashboard/index';
        ...
        $view->registerEngines(
            [
                '.volt' => function ($view) use ($options) {
                    ...
                    $volt->getCompiler()->addFunction('asset', $domain);
